...
const BoxStyled = styled(Box)`
  background-image: url("https://shechocolate.com/cdn/shop/collections/114101007-A_1512x.jpg?v=1687422096");
              ...
              <Grid key={product.prodId} item xs={12} sm={6} md={4}>
                <Box>
                  <Box>
                    ...
                    <ButtonStyled variant="contained" style={{width: 250, marginTop: 10, background: 'transparent', color: 'black', border: '1px solid black'}} component={Link} to={`/embroideries/quickView/${product.id}`}>Quick View</ButtonStyled>
                  </Box>
                </Box>
              </Grid>
            ))}
