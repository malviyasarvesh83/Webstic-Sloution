import { jacketQuickViewDetails, jacketAddToCartDetails } from "../services/api";
...
const JacketQuickView = () => {
  ...
  const jacketQuickView = async () => {
    const response = await jacketQuickViewDetails(id);
  ...
  const addToCart = async (id) => {
    await jacketAddToCartDetails(id, count);
    navigate('/');
  }
...
export default JacketQuickView;