import { jilbabQuickViewDetails, jilbabAddToCartDetails } from "../services/api";
...
const JilbabQuickView = () => {
  ...
  const jilbabQuickView = async () => {
    const response = await jilbabQuickViewDetails(id);
  ...
  const addToCart = async (id) => {
    await jilbabAddToCartDetails(id, count);
    navigate('/');
  }
...
export default JilbabQuickView;